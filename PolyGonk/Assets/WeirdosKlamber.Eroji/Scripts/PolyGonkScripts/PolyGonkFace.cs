    ...
    public class PolyGonkFace : MonoBehaviour
    {
        ...
        void Update()
        {
                ...
                if (transform.localScale.x>1f)
                {
                    ...
                    for (int i = 0; i < buttonArray.Length; i++)
                    {
                        ...
                        if (i == 6)//meaning 7
                        {
                            ...
                            { 
                                growButton7= true;
                               // button7Holder.transform.localScale = new Vector2(0.01f, 0.01f);
                   ...
                   // print("mouth pos is " + mouth.transform.position);
            ...
            else if (growButton7)
            {
                ...
                {
                   // button7Holder.transform.localScale = new Vector2(button7GrowTimer,button7GrowTimer);
                }
                else 
                {
                    growButton7 = false;
                    dingFX.Play();
                   // button7Holder.transform.localScale = new Vector2(1f, 1f);
            ...
            if (eating)
            {
                ...
                if (camTimer >= 1f)
                {
                   // print("titleLocalPos:" + polygonkTitleObject.transform.localPosition);
                    mouth.transform.localScale = new Vector2(130f - (camTimer-1f) * 130f, 130f - (camTimer - 1f) * 130f);
                    //print("mouth:" + mouth.transform.localScale);
                }
                else if (camTimer>0f)
                {
        ...
        {
            eating= true;
            print("title localPOS:" + polygonkTitleObject.transform.localPosition);
        }
    }
}